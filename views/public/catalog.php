...
<section class="section-block">
    ...
    <div class="section-surface">
        <?php if ($category === 'heatPumps'): ?>
            ...
            <p>Ориентировъчно решенията въздух-вода за средно жилище започват от около 10 000–15 000 лв. в зависимост от мощността, марката и типа инсталация. За точна оферта е най-добре да направим консултация според конкретния дом. При покупка на нова термопомпа може да проверите и актуалните национални програми за енергийна ефективност и субсидии.</p>
        <?php else: ?>
            <div class="section-heading">
                <span class="section-heading__eyebrow">Гид за избор</span>
            ...
            <p>Обърнете внимание и на нивото на шум (dB), наличието на Wi-Fi управление и вида на филтрите. В цената на много от моделите е включен стандартен монтаж до 3 метра тръбен път — при по-дълга трасе или специфичен монтаж уточняваме допълнителните детайли предварително. Разгледайте моделите по-долу и филтрирайте по марка, технология и мощност, за да стесните избора си бързо.</p>
        <?php endif; ?>
    </div>
