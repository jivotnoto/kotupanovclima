<section class="section-block">
    <div class="section-surface">
        <div class="section-heading">
            ...
            <h1 class="section-heading__title">Актуални оферти и по-силно поднесени промоционални цени</h1>
            <p>Подбрани предложения за климатици и термопомпи, подредени така, че клиентът да вижда веднага стойността, монтажа и причината да избере точно тази оферта.</p>
        </div>
    </div>
